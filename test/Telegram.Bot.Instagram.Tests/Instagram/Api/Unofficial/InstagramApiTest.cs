...
namespace Telegram.Bot.Instagram.Tests.Instagram.Api.Unofficial
{
    public class InstagramApiTest
    {
        ...
        {
            var messageHandlerMock = new HttpClientHandlerMock();
            using (var api = new InstagramApi(messageHandlerMock))
            {
                ...
                HttpRequestMessage request = messageHandlerMock.Request;
        ...
        {
            var messageHandlerMock = new HttpClientHandlerMock { Response = new HttpResponseMessage(HttpStatusCode.Unauthorized) };
            using var api = new InstagramApi(messageHandlerMock);
            Assert.Null(api.UserName);
        ...
        private class HttpClientHandlerMock : HttpClientHandler
        {
